            ...
            <section className="relative pt-40 pb-20 px-6 overflow-hidden gold-texture-bg">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <span className="text-white text-xs font-bold tracking-[0.3em] uppercase drop-shadow-[0_1px_2px_rgba(0,0,0,0.4)]">Construction & Execution</span>
                    </div>
                    ...
                    <p className="text-xl text-white/85 drop-shadow-[0_1px_2px_rgba(0,0,0,0.5)] max-w-3xl leading-relaxed mb-12">
